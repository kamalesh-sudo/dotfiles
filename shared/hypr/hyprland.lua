...
--hl.keyword("xwayland", "force_zero_scaling = true")
...
hl.bind(mainMod .. " + SPACE ",hl.dsp.exec_cmd("qs -p /home/kamal/.config/quickshell/yahpax ipc call appLauncher toggle"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("qs -p /home/kamal/.config/quickshell/yahpax ipc call wallpaperSelector toggle "))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("qs -p /home/kamal/.config/quickshell/yahpax ipc call clipboardHistory toggle"))
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("qs -p /home/kamal/.config/quickshell/yahpax ipc call notifications toggle"))
...
hl.on("hyprland.start", function()
hl.exec_cmd("~/.config/quickshell/yahpax/launch.fish")
end)

hl.on("hyprland.shutdown", function()
hl.exec_cmd("~/.config/quickshell/yahpax/logout-cleanup.fish")
end)
